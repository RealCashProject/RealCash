...
const uint64_t MONEY_SUPPLY				                     = UINT64_C(55000000000000000); //550M
const uint64_t FINAL_SUBSIDY_PER_MINUTE			             = UINT64_C(30000000); //0.30 RL
...
const int      RPC_DEFAULT_PORT                              =  16002;
