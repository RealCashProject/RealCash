...
const char COMMUNITY_FORUM_URL[] = "https://realcash.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://realcash.me";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("RealCash Wallet %1").arg(Settings::instance().getVersion()));
